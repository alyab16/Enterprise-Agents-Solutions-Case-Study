...
\item All invoices are single-currency (CAD) with no partial payments, credit memos, or discounts
...
%==============================================================================
\section{Multi-Agent Architecture via Model Context Protocol (MCP) Server Connections \textit{--- Proposed Extension}}
